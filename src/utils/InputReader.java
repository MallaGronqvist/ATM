...
public class InputReader {
    ...
    // Checks whether customer chooses to discontinue while signing up or signing in.
    // Navigates the customer back to the main menu.
    ...
    public static boolean discontinuedInput(String input) {
